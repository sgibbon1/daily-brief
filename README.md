...
```
0 17 * * * cd "/Users/yourname/Library/CloudStorage/GoogleDrive-your.email@example.com/My Drive/Sean/Code/ai_code/daily_brief" && /usr/bin/python3 daily_brief.py >> output/cron.log 2>&1
```
